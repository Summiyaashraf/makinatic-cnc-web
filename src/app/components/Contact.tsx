      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="text-gray-600 text-sm md:text-lg font-medium px-4">
            {isAr ? 'تواصل مع فريقنا في جدة لجميع الاستفسارات التقنية والتجارية.' : 'Contact our Jeddah team for inquiries.'}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="h-[350px] md:h-full min-h-[350px] md:min-h-[500px] bg-white rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl border-4 border-blue-800 relative order-1 lg:order-2">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3710.021021764654!2d39.1833333!3d21.585!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjHCsDM1JzA2LjAiTiAzOcKwMTEnMDAuMCJF!5e0!3m2!1sen!2ssa!4v1715000000000!5m2!1sen!2ssa"
